...
CYCLE by Gerard Valls Montaño (bygerardvisuals.com/cycle)
 ...
 - When it finishes, a PNG image (e.g., Capture_Cycle_1.png) will be
 automatically saved in the project folder. Files are auto-numbered to avoid overwriting.
 ...
 It is licensed under the terms of the **Creative Commons Attribution 4.0 International (CC BY 4.0)**.
 
 YOU MAY:
 Use it freely (for personal, artistic, or commercial purposes).
 Modify and adapt it.
 Share and remix it.
 
 YOU MUST:
 Credit the original author.
 (Do not falsely claim it as your own if you haven't significantly modified it)
 
 SUGGESTED ATTRIBUTION:
 > Based on code developed by Gerard Valls Montaño (bygerardvisuals.com) / Licensed under CC BY 4.0
